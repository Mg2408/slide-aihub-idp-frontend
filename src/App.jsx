...
import ObservabilityDashboard from './SidebarComponents/ObservabilityDashboard';
...
const MyMenu = ({ collapsed }) => {
  ...
  const pathToKey = {
    ...
    '/mortgage': '2',
    '/windmit': '3',
    '/batch-dashboard-windmit': '4',
    '/batch-dashboard-mortgage': '5',
    '/email': '6',
...
{/*      
       <Menu.Item key="4" icon={<FileTextOutlined />} title={"Batch Dashboard wind mitigation"}>
        {!collapsed ? <Link to="/batch-dashboard-windmit" style={{ textDecoration: 'none' }}>Batch Processing Wind Mitigation</Link> : <Link to="/batch-dashboard-windmit" style={{ textDecoration: 'none' }} />}
      </Menu.Item>
       <Menu.Item key="5" icon={<FileTextOutlined />} title={"Batch Dashboard Mortgage"}>
        {!collapsed ? <Link to="/batch-dashboard-mortgage" style={{ textDecoration: 'none' }}>Batch Processing Mortgage</Link> : <Link to="/batch-dashboard-mortgage" style={{ textDecoration: 'none' }} />}
      </Menu.Item> */}
      ...
      <Layout>
        ...
        >
          ...
          <Routes>
            ...
            <Route path="dashboard" element={<ObservabilityDashboard />} />
            <Route path="windmit" element={<Dashboard />} />
